...
<div class="container-fluid suredy-form" style="width: 1260px;">
	<input type="hidden" id="thisnodeid" name="thisnodeid"
		value="${thisnodeid}" />
							...
							<div class=" col-md-3">
								<div class="form-group">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="assetId" name="assetId" value="${ea.assetId}" maxlength="50" />
									</div>
								</div>
							</div>
							<div class=" col-md-3">
...
<script type="text/javascript"
	src="${request.contextPath}/app/equipasset/equipasset-update.js"></script>
<script type="text/javascript">
