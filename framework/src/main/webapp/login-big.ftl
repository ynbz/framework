...
<div class="container-fluid">
	<div class="row logo">
		<div class="col-md-12 text-center">
			<img src="${request.contextPath}/img/login/it_logo.png" />
		</div>
	</div>
		...
		<div class="row">
			<div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
				<div class="form-group">
					<div class="input-group select-unit">
						...
						<input name="unitName" id="unitName" class="form-control input-lg" type="text" value="" placeholder="&lt;请选择登录单位&gt;" readonly="readonly" />
					</div>
				</div>
			</div>
			<div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
				<div class="form-group">
					<div class="input-group select-user">
						...
						<input name="userName" id="userName" class="form-control input-lg" type="text" value="" placeholder="&lt;请选择登录用户&gt;" readonly="readonly" />
					</div>
				</div>
			</div>
			<div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
			...
			<div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
				<div class="form-group">
					<div class="input-group">
						<div class="input-group-addon">
							<div class="login-form-icon">
								<i class="icon-lock icon-2x" style="color:#efbf4d"></i>
							</div>
						</div>
...
<script src="${request.contextPath}/js/login-big.js"></script>
</@t.foot>
